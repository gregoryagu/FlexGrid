...
export class BreezeCollectionView extends wijmo.collections.CollectionView {
    ...
    */
    constructor(collectionViewOptions: any, flexGridOptions: any) {
        super();
        this._manager = collectionViewOptions.entityManager;
        this._entityType = collectionViewOptions.entityType;
        this._entityQuery = collectionViewOptions.entityQuery;
        ...
        this._queryData();
        this.newItemCreator = () => {
            let newItem = this._manager.createEntity(this._entityType);
            return newItem;
        }
        if (collectionViewOptions.currentChanged) {
            this.currentChanged.addHandler(collectionViewOptions.currentChanged);
        }
    }
